...
//     Versão de Tempo de Execução: 17.0.0.0
//  
...
if ((EntityTypeValueAcquired == false))
{
    ...
    if ((string.IsNullOrEmpty(parameterValue) == false))
    {
        ...
        {
            this.Error("O tipo \'Microsoft.EntityFrameworkCore.Metadata.IEntityType\' do parâmetro \'EntityT" +
                    "ype\' não corresponde ao tipo de dado passado para o modelo.");
        }
    }
}
if ((EntityTypeValueAcquired == false))
...
if ((OptionsValueAcquired == false))
{
    ...
    if ((string.IsNullOrEmpty(parameterValue) == false))
    {
        ...
        {
            this.Error("O tipo \'Microsoft.EntityFrameworkCore.Scaffolding.ModelCodeGenerationOptions\' do " +
                    "parâmetro \'Options\' não corresponde ao tipo de dado passado para o modelo.");
        }
    }
}
if ((OptionsValueAcquired == false))
...
if ((NamespaceHintValueAcquired == false))
{
    ...
    if ((string.IsNullOrEmpty(parameterValue) == false))
    {
        ...
        {
            this.Error("O tipo \'System.String\' do parâmetro \'NamespaceHint\' não corresponde ao tipo de da" +
                    "do passado para o modelo.");
        }
    }
}
if ((NamespaceHintValueAcquired == false))
